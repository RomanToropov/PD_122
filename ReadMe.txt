...
TODO:
1. Вызвать функции insert() и print() без передачи в них корня дерева;
2. В класс Tree добавить методы:
	int minValue()const;	//возвращает минимальное значение в дереве
	int maxValue()const;	//возвращает максимальное значение в дереве
	int count()const;		//возвращает количество элементов в дереве
	int sum()const;			//сумма элементов дерева
	double avg()const;		//среднее арифметическое элементов дерева
