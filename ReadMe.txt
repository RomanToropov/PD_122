...
TODO:
1. Загрузка базы из файла;				DONE
2. Выборка данных по заданному номеру;	
3. Выборка всех номеров, совершивших заданное нарушение;
4. Сделать меню, из которого выбираются соответствующие действия; DONE
5.** Добавить дату и время происшествия;
...
Необходимо также реализовать следующие операции:
	■ Полная распечатка базы данных (по номерам машин и списку правонарушений, числящихся за ними); DONE
